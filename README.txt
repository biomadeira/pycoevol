...
NCBI database "refseq_protein" ftp://ftp.ncbi.nlm.nih.gov/blast/db/
...
Usage: 
python Pycoevol.py  -input1 -input2 -psiblast -alignment -coevolution
...
Example: 
python Pycoevol.py -3DX6.pdb:A -A2TP.pdb:A -internet -clustalw -mi

Pycoevol.py is the main execution file which parses files and options
as arguments.
Parameters.py must be edited in order to specify some parameters.

The folder layout must be kept as the following:
./Pycoevol/Pycoevol.py
./Pycoevol/Parameters.py
./Pycoevol/README.txt
./Pycoevol/Data 
./Pycoevol/Results 
./Pycoevol/Matrix
...
./Pycoevol/src 
./Pycoevol/src/tools
./Pycoevol/src/tools/clustalw
./Pycoevol/src/tools/blast+ (optional)
./Pycoevol/src/tools/blast+/db (optional)
./Pycoevol/src/tools/muscle (optional)
./Pycoevol/src/tools/mafft (optional)
./Pycoevol/refseq_protein.pal(optional)
